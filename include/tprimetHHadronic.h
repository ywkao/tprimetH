...
// makeCMS3ClassFiles("/afs/cern.ch/work/y/ykao/tPrimeExcessHgg/CMSSW_10_6_8/src/tprimetH/rootfiles/ntuples_v2.4/TprimeBToTH_M-1000_Era2016_v2p4.root", "tagsDumper/trees/tHq_13TeV_THQHadronicTag", "tprimetHHadronic", "tprime", "analyzer")
...
class tprimetHHadronic {
 ...
 protected: 
  ...
  float    mom_parton1_pt_;
  TBranch *mom_parton1_pt_branch;
  bool     mom_parton1_pt_isLoaded;
  float    mom_parton2_pt_;
  TBranch *mom_parton2_pt_branch;
  bool     mom_parton2_pt_isLoaded;
  float    mom_parton3_pt_;
  TBranch *mom_parton3_pt_branch;
  bool     mom_parton3_pt_isLoaded;
  float    mom_parton4_pt_;
  TBranch *mom_parton4_pt_branch;
  bool     mom_parton4_pt_isLoaded;
  float    mom_parton5_pt_;
  TBranch *mom_parton5_pt_branch;
  bool     mom_parton5_pt_isLoaded;
  float    mom_parton6_pt_;
  TBranch *mom_parton6_pt_branch;
  bool     mom_parton6_pt_isLoaded;
  float    mom_parton7_pt_;
  TBranch *mom_parton7_pt_branch;
  bool     mom_parton7_pt_isLoaded;
  float    mom_parton8_pt_;
  TBranch *mom_parton8_pt_branch;
  bool     mom_parton8_pt_isLoaded;
  float    mom_parton9_pt_;
  TBranch *mom_parton9_pt_branch;
  bool     mom_parton9_pt_isLoaded;
  float    mom_parton10_pt_;
  TBranch *mom_parton10_pt_branch;
  bool     mom_parton10_pt_isLoaded;
  float    mom_parton1_eta_;
  TBranch *mom_parton1_eta_branch;
  bool     mom_parton1_eta_isLoaded;
  float    mom_parton2_eta_;
  TBranch *mom_parton2_eta_branch;
  bool     mom_parton2_eta_isLoaded;
  float    mom_parton3_eta_;
  TBranch *mom_parton3_eta_branch;
  bool     mom_parton3_eta_isLoaded;
  float    mom_parton4_eta_;
  TBranch *mom_parton4_eta_branch;
  bool     mom_parton4_eta_isLoaded;
  float    mom_parton5_eta_;
  TBranch *mom_parton5_eta_branch;
  bool     mom_parton5_eta_isLoaded;
  float    mom_parton6_eta_;
  TBranch *mom_parton6_eta_branch;
  bool     mom_parton6_eta_isLoaded;
  float    mom_parton7_eta_;
  TBranch *mom_parton7_eta_branch;
  bool     mom_parton7_eta_isLoaded;
  float    mom_parton8_eta_;
  TBranch *mom_parton8_eta_branch;
  bool     mom_parton8_eta_isLoaded;
  float    mom_parton9_eta_;
  TBranch *mom_parton9_eta_branch;
  bool     mom_parton9_eta_isLoaded;
  float    mom_parton10_eta_;
  TBranch *mom_parton10_eta_branch;
  bool     mom_parton10_eta_isLoaded;
  float    mom_parton1_phi_;
  TBranch *mom_parton1_phi_branch;
  bool     mom_parton1_phi_isLoaded;
  float    mom_parton2_phi_;
  TBranch *mom_parton2_phi_branch;
  bool     mom_parton2_phi_isLoaded;
  float    mom_parton3_phi_;
  TBranch *mom_parton3_phi_branch;
  bool     mom_parton3_phi_isLoaded;
  float    mom_parton4_phi_;
  TBranch *mom_parton4_phi_branch;
  bool     mom_parton4_phi_isLoaded;
  float    mom_parton5_phi_;
  TBranch *mom_parton5_phi_branch;
  bool     mom_parton5_phi_isLoaded;
  float    mom_parton6_phi_;
  TBranch *mom_parton6_phi_branch;
  bool     mom_parton6_phi_isLoaded;
  float    mom_parton7_phi_;
  TBranch *mom_parton7_phi_branch;
  bool     mom_parton7_phi_isLoaded;
  float    mom_parton8_phi_;
  TBranch *mom_parton8_phi_branch;
  bool     mom_parton8_phi_isLoaded;
  float    mom_parton9_phi_;
  TBranch *mom_parton9_phi_branch;
  bool     mom_parton9_phi_isLoaded;
  float    mom_parton10_phi_;
  TBranch *mom_parton10_phi_branch;
  bool     mom_parton10_phi_isLoaded;
  float    mom_parton1_mass_;
  TBranch *mom_parton1_mass_branch;
  bool     mom_parton1_mass_isLoaded;
  float    mom_parton2_mass_;
  TBranch *mom_parton2_mass_branch;
  bool     mom_parton2_mass_isLoaded;
  float    mom_parton3_mass_;
  TBranch *mom_parton3_mass_branch;
  bool     mom_parton3_mass_isLoaded;
  float    mom_parton4_mass_;
  TBranch *mom_parton4_mass_branch;
  bool     mom_parton4_mass_isLoaded;
  float    mom_parton5_mass_;
  TBranch *mom_parton5_mass_branch;
  bool     mom_parton5_mass_isLoaded;
  float    mom_parton6_mass_;
  TBranch *mom_parton6_mass_branch;
  bool     mom_parton6_mass_isLoaded;
  float    mom_parton7_mass_;
  TBranch *mom_parton7_mass_branch;
  bool     mom_parton7_mass_isLoaded;
  float    mom_parton8_mass_;
  TBranch *mom_parton8_mass_branch;
  bool     mom_parton8_mass_isLoaded;
  float    mom_parton9_mass_;
  TBranch *mom_parton9_mass_branch;
  bool     mom_parton9_mass_isLoaded;
  float    mom_parton10_mass_;
  TBranch *mom_parton10_mass_branch;
  bool     mom_parton10_mass_isLoaded;
  float    mom_parton1_pdgId_;
  TBranch *mom_parton1_pdgId_branch;
  bool     mom_parton1_pdgId_isLoaded;
  float    mom_parton2_pdgId_;
  TBranch *mom_parton2_pdgId_branch;
  bool     mom_parton2_pdgId_isLoaded;
  float    mom_parton3_pdgId_;
  TBranch *mom_parton3_pdgId_branch;
  bool     mom_parton3_pdgId_isLoaded;
  float    mom_parton4_pdgId_;
  TBranch *mom_parton4_pdgId_branch;
  bool     mom_parton4_pdgId_isLoaded;
  float    mom_parton5_pdgId_;
  TBranch *mom_parton5_pdgId_branch;
  bool     mom_parton5_pdgId_isLoaded;
  float    mom_parton6_pdgId_;
  TBranch *mom_parton6_pdgId_branch;
  bool     mom_parton6_pdgId_isLoaded;
  float    mom_parton7_pdgId_;
  TBranch *mom_parton7_pdgId_branch;
  bool     mom_parton7_pdgId_isLoaded;
  float    mom_parton8_pdgId_;
  TBranch *mom_parton8_pdgId_branch;
  bool     mom_parton8_pdgId_isLoaded;
  float    mom_parton9_pdgId_;
  TBranch *mom_parton9_pdgId_branch;
  bool     mom_parton9_pdgId_isLoaded;
  float    mom_parton10_pdgId_;
  TBranch *mom_parton10_pdgId_branch;
  bool     mom_parton10_pdgId_isLoaded;
  float    mom_parton1_status_;
  TBranch *mom_parton1_status_branch;
  bool     mom_parton1_status_isLoaded;
  float    mom_parton2_status_;
  TBranch *mom_parton2_status_branch;
  bool     mom_parton2_status_isLoaded;
  float    mom_parton3_status_;
  TBranch *mom_parton3_status_branch;
  bool     mom_parton3_status_isLoaded;
  float    mom_parton4_status_;
  TBranch *mom_parton4_status_branch;
  bool     mom_parton4_status_isLoaded;
  float    mom_parton5_status_;
  TBranch *mom_parton5_status_branch;
  bool     mom_parton5_status_isLoaded;
  float    mom_parton6_status_;
  TBranch *mom_parton6_status_branch;
  bool     mom_parton6_status_isLoaded;
  float    mom_parton7_status_;
  TBranch *mom_parton7_status_branch;
  bool     mom_parton7_status_isLoaded;
  float    mom_parton8_status_;
  TBranch *mom_parton8_status_branch;
  bool     mom_parton8_status_isLoaded;
  float    mom_parton9_status_;
  TBranch *mom_parton9_status_branch;
  bool     mom_parton9_status_isLoaded;
  float    mom_parton10_status_;
  TBranch *mom_parton10_status_branch;
  bool     mom_parton10_status_isLoaded;
...
void LoadAllBranches(); 
  ...
  const float &mom_parton1_pt();
  const float &mom_parton2_pt();
  const float &mom_parton3_pt();
  const float &mom_parton4_pt();
  const float &mom_parton5_pt();
  const float &mom_parton6_pt();
  const float &mom_parton7_pt();
  const float &mom_parton8_pt();
  const float &mom_parton9_pt();
  const float &mom_parton10_pt();
  const float &mom_parton1_eta();
  const float &mom_parton2_eta();
  const float &mom_parton3_eta();
  const float &mom_parton4_eta();
  const float &mom_parton5_eta();
  const float &mom_parton6_eta();
  const float &mom_parton7_eta();
  const float &mom_parton8_eta();
  const float &mom_parton9_eta();
  const float &mom_parton10_eta();
  const float &mom_parton1_phi();
  const float &mom_parton2_phi();
  const float &mom_parton3_phi();
  const float &mom_parton4_phi();
  const float &mom_parton5_phi();
  const float &mom_parton6_phi();
  const float &mom_parton7_phi();
  const float &mom_parton8_phi();
  const float &mom_parton9_phi();
  const float &mom_parton10_phi();
  const float &mom_parton1_mass();
  const float &mom_parton2_mass();
  const float &mom_parton3_mass();
  const float &mom_parton4_mass();
  const float &mom_parton5_mass();
  const float &mom_parton6_mass();
  const float &mom_parton7_mass();
  const float &mom_parton8_mass();
  const float &mom_parton9_mass();
  const float &mom_parton10_mass();
  const float &mom_parton1_pdgId();
  const float &mom_parton2_pdgId();
  const float &mom_parton3_pdgId();
  const float &mom_parton4_pdgId();
  const float &mom_parton5_pdgId();
  const float &mom_parton6_pdgId();
  const float &mom_parton7_pdgId();
  const float &mom_parton8_pdgId();
  const float &mom_parton9_pdgId();
  const float &mom_parton10_pdgId();
  const float &mom_parton1_status();
  const float &mom_parton2_status();
  const float &mom_parton3_status();
  const float &mom_parton4_status();
  const float &mom_parton5_status();
  const float &mom_parton6_status();
  const float &mom_parton7_status();
  const float &mom_parton8_status();
  const float &mom_parton9_status();
  const float &mom_parton10_status();

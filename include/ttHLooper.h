...
void add_variables(vector<Process*> v, TString tag, vector<TString> syst_labels = {""}) {
  ...
  for (unsigned int j = 0; j < syst_labels.size(); j++) {
      for (int i = 0; i < v.size(); i++) {
        ...
        v[i]->add_histogram("h" + syst_labels[j] + "chi2_bjet_phi"                 , 25  , -3.    , 3.    );
        v[i]->add_histogram("h" + syst_labels[j] + "chi2_wjet1_phi"                , 25  , -3.    , 3.    );
        v[i]->add_histogram("h" + syst_labels[j] + "chi2_wjet2_phi"                , 25  , -3.    , 3.    );
        ...
        v[i]->add_histogram("h" + syst_labels[j] + "MetPt"                         , 25  , 0      , 500   );
        ...
        v[i]->add_histogram("h" + syst_labels[j] + "Jet1Phi"                       , 25  , -3.    , 3.    );
        v[i]->add_histogram("h" + syst_labels[j] + "Jet2Phi"                       , 25  , -3.    , 3.    );
        v[i]->add_histogram("h" + syst_labels[j] + "Jet3Phi"                       , 25  , -3.    , 3.    );
        v[i]->add_histogram("h" + syst_labels[j] + "Jet4Phi"                       , 25  , -3.    , 3.    );
        v[i]->add_histogram("h" + syst_labels[j] + "Jet5Phi"                       , 25  , -3.    , 3.    );
        v[i]->add_histogram("h" + syst_labels[j] + "Jet6Phi"                       , 25  , -3.    , 3.    );
        ...
        // more{{{
        // BDTG
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_nrb_varset8_mixed03_tmva_bdtg_n50"              , 50   , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_nrb_varset8_mixed03_tmva_bdtg_n2000"            , 2000 , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_nrb_varset8_mixed04_tmva_bdtg_n50"              , 50   , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_nrb_varset8_mixed04_tmva_bdtg_n2000"            , 2000 , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_nrb_varset8_mixed05_tmva_bdtg_n50"              , 50   , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_nrb_varset8_mixed05_tmva_bdtg_n2000"            , 2000 , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_smh_varset8_mixed03_tmva_bdtg_n50"              , 50   , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_smh_varset8_mixed03_tmva_bdtg_n2000"            , 2000 , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_smh_varset8_mixed04_tmva_bdtg_n50"              , 50   , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_smh_varset8_mixed04_tmva_bdtg_n2000"            , 2000 , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_smh_varset8_mixed05_tmva_bdtg_n50"              , 50   , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_smh_varset8_mixed05_tmva_bdtg_n2000"            , 2000 , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_smh_varset8_mixed03_tmva_bdtg_withNRBcut_n50"   , 50   , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_smh_varset8_mixed03_tmva_bdtg_withNRBcut_n2000" , 2000 , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_smh_varset8_mixed04_tmva_bdtg_withNRBcut_n50"   , 50   , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_smh_varset8_mixed04_tmva_bdtg_withNRBcut_n2000" , 2000 , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_smh_varset8_mixed05_tmva_bdtg_withNRBcut_n50"   , 50   , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_smh_varset8_mixed05_tmva_bdtg_withNRBcut_n2000" , 2000 , -1. , 1.);

        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_nrb_varset8_mixed03_tmva_bdtg_mggWindow_n50"            , 50 , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_nrb_varset8_mixed04_tmva_bdtg_mggWindow_n50"            , 50 , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_nrb_varset8_mixed05_tmva_bdtg_mggWindow_n50"            , 50 , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_smh_varset8_mixed03_tmva_bdtg_mggWindow_n50"            , 50 , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_smh_varset8_mixed04_tmva_bdtg_mggWindow_n50"            , 50 , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_smh_varset8_mixed05_tmva_bdtg_mggWindow_n50"            , 50 , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_smh_varset8_mixed03_tmva_bdtg_mggWindow_withNRBcut_n50" , 50 , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_smh_varset8_mixed04_tmva_bdtg_mggWindow_withNRBcut_n50" , 50 , -1. , 1.);
        v[i]->add_histogram("h" + syst_labels[j] + "MVA_value_smh_varset8_mixed05_tmva_bdtg_mggWindow_withNRBcut_n50" , 50 , -1. , 1.);
...
TF1* get_photon_ID_shape(TString type) {
  ...
  if (type == "min") {
    ...
    // tprime UL (18. Jan. 2022)
    f_IDMVA->SetParameter(0, 82.6301  );
    f_IDMVA->SetParameter(1, -107.917 );
    f_IDMVA->SetParameter(2, 204.733  );
    f_IDMVA->SetParameter(3, -96.6356 );
    f_IDMVA->SetParameter(4, -495.099 );
    f_IDMVA->SetParameter(5, 389.443  );
    f_IDMVA->SetParameter(6, 968.924  );
    f_IDMVA->SetParameter(7, -898.986 );
  }

  else if (type == "fake_tprime_ReReco") {
    // tprime ReReco (05 Aug 2021)
...
TF1* get_scale_factor_function_HT(int shift) {
    TF1 *f1 = new TF1("f1", "[0] + [1]*x", 100., 10000.);
    double p0 = 1.11181e+00;
    double p1 = -5.30993e-04;

    if(shift>0) {
        f1->SetParameters(p0*1.5, p1); // upper 50 %
        printf(">>> HT_scale_factor: upward variation\n");
    } else if(shift<0) {
        f1->SetParameters(p0*0.5, p1); // lower 50 %
        printf(">>> HT_scale_factor: downward variation\n");
    } else {
        f1->SetParameters(p0, p1); // central
        printf(">>> HT_scale_factor: central\n");
    }
...
double get_weight_from_template_fit(TString year, int processId) {
    ...
    if(processId==18 || processId==2) {
        if(year=="2016") {
            if(processId==2)  return 1.42346e+00; //1.44207e+00; // gamma gamma + jets
            if(processId==18) return 1.05994e+00; //1.06025e+00; // (gamma) + jets
        }
        if(year=="2017" || year=="2018") {
            if(processId==2)  return 9.40968e-01; //9.41576e-01; // gamma gamma + jets
            if(processId==18) return 9.57207e-01; //9.57207e-01; // (gamma) + jets
        }

...
for file in rootfiles:
    ...
    toolbox.make_plot_two_hists(h_mass_wboson , "Minimum chi-2" , h_mass_tm_wboson  , "Truth-Matched" , "h_tmReco_mass_wboson_%s.%s"   %  (tag , ext) )
    toolbox.make_plot_two_hists(h_mass_top    , "Minimum chi-2" , h_mass_tm_top     , "Truth-Matched" , "h_tmReco_mass_top_%s.%s"      %  (tag , ext) )
    toolbox.make_plot_two_hists(h_mass_tprime , "Minimum chi-2" , h_mass_tm_tprime  , "Truth-Matched" , "h_tmReco_mass_tprime_%s.%s"   %  (tag , ext) )

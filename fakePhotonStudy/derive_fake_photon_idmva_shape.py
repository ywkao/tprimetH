...
def check_fake_pdf(output): #{{{
    ...
    f_IDMVA_v1 = ROOT.TF1("f_IDMVA_v1", "[0] + [1]*x + [2]*x^2 + [3]*x^3 + [4]*x^4 + [5]*x^5 + [6]*x^6 + [7]*x^7", -1.0, 1.0)
    f_IDMVA_v1.SetParameter(0, 178.267  )
    f_IDMVA_v1.SetParameter(1, -196.404 )
    f_IDMVA_v1.SetParameter(2, 332.454  )
    f_IDMVA_v1.SetParameter(3, -524.491 )
    f_IDMVA_v1.SetParameter(4, -760.702 )
    f_IDMVA_v1.SetParameter(5, 1831.3   )
    f_IDMVA_v1.SetParameter(6, 1624.34  )
    f_IDMVA_v1.SetParameter(7, -2449.23 )
    f_IDMVA_v1.SetLineColor(ROOT.kGreen)
    f_IDMVA_v1.SetNormalized(True)

    f_IDMVA_v2 = ROOT.TF1("f_IDMVA_v2", "[0] + [1]*x + [2]*x^2 + [3]*x^3 + [4]*x^4 + [5]*x^5 + [6]*x^6 + [7]*x^7", -1.0, 1.0)
    f_IDMVA_v2.SetParameter(0, 82.6301  )
    f_IDMVA_v2.SetParameter(1, -107.917 )
    f_IDMVA_v2.SetParameter(2, 204.733  )
    f_IDMVA_v2.SetParameter(3, -96.6356 )
    f_IDMVA_v2.SetParameter(4, -495.099 )
    f_IDMVA_v2.SetParameter(5, 389.443   )
    f_IDMVA_v2.SetParameter(6, 968.924  )
    f_IDMVA_v2.SetParameter(7, -898.986 )
    f_IDMVA_v2.SetLineColor(ROOT.kRed)
    f_IDMVA_v2.SetNormalized(True)
    ...
    legend.AddEntry(f_IDMVA_v1     , "tprime UL v1"     , "l")
    legend.AddEntry(f_IDMVA_v2     , "tprime UL v2"     , "l")

    f_IDMVA_fcnc.Draw()
    #f_IDMVA_tprime.Draw("same")
    f_IDMVA_v1.Draw("same")
    f_IDMVA_v2.Draw("same")
    legend.Draw("same")
